...
At the core of Sprout is the [data package](/docs/design/implementation/outputs.qmd),
...
`~/.sprout/packages/` on Linux (see [Outputs](/docs/design/implementation/outputs.qmd)
