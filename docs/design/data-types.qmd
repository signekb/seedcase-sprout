...
We will be using the Varchar without a limit for Seedcase Sprout, in the application this will be called a Text field even though it is the name of a different data type.
