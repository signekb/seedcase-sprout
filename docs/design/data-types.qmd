...
The primary data types in most databases are text, numbers, dates (or time or date-time) and some form of true/false (boolean, logic) option. Below is a table summarizing the data types used.
...
A standard data type in any system is the option of a boolean/logical value, which can represent a set of either/or options. This will be true/false. The values stored in the system will typically be 0 and 1 (or -1 and 0) and the interpretation of these is up to the individual data user.
