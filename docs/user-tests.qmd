...
For our user tests, we want to create some context for the user to test
the features within Sprout. We have create a simple case with three
...
Sprout is a component of the Seedcase software ecosystem aiming to:

> to take data created or collected for research studies and "grow" it
