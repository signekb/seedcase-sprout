...
def validate_no_special_characters(
    ...
    Returns:
        forms.ValidationError | None: Returns validation error, if validation fails
    """
...
def validate_table_name_does_not_exist(name: str) -> forms.ValidationError | None:
    """
