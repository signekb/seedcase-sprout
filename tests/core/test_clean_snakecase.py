...
class ConvertToSnakeCase(TestCase):
    ...
    def test_convert_to_snake_case_numbers_and_non_alphanumeric_characters(self):
        string = convert_to_snake_case("Num8ers & nona|phanumeric characters")
